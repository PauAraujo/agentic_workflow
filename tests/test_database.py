...
from sql_query_assistant.utils.database import attach_all_schema_databases, _validate_schema_name
...
@pytest.mark.parametrize("schema_name,reason", [
...
def test_attach_all_schema_databases_with_valid_schemas(tmp_path, dummy_settings):
    ...
    attach_all_schema_databases(cursor, dummy_settings)
...
def test_attach_all_schema_databases_validates_schema_names(tmp_path, dummy_settings, caplog):
...
def test_attach_all_schema_databases_handles_empty_directory(tmp_path, dummy_settings, caplog):
